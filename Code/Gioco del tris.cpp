...
int main()
{
	...
	while(v)
	{
		...
		do {
			cout<<endl<<"Fai la tua mossa"<<endl;
			do {
				do {
					cout<<"Lettera:";
					cin>>let;
		...
		{
		case 1:
			cout<<"\033[1;32m"<<"Hai Vinto";
			break;
		case 0:
			cout<<"\033[1;33m"<<"Pareggio";
			break;
		case -1:
			cout<<"\033[1;31m"<<"Hai perso";
			break;
		default:
			system("Color 04");
		...
		char pa='a';
		do {
			cout<<endl<<endl<<"Giocare di nuovo?(s/n): ";
			cin>>pa;
			if(pa=='s'||pa=='S')
				v=1;
			else if(pa=='n'||pa=='N')
				v=0;
		} while(pa!='n'&&pa!='N'&&pa!='s'&&pa!='S');
	}
	return 0;
}
